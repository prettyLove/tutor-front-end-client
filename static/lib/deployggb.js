    ...
    var fetchParametersFromTube = function (successCallback, materialsApiURL) {
        ...
        var api_request = {
            request: {
                ...
                task: {
                    "-type": "fetch",
                    fields: {field: [{"-name": "id"}, {"-name": "geogebra_format"}, {"-name": "width"}, {"-name": "height"}, {"-name": "toolbar"}, {"-name": "menubar"}, {"-name": "inputbar"}, {"-name": "stylebar"}, {"-name": "reseticon"}, {"-name": "labeldrags"}, {"-name": "shiftdragzoom"}, {"-name": "rightclick"}, {"-name": "ggbbase64"}, {"-name": "preview_url"}, {"-name": "appname"}]},
...
if (typeof window.web3d !== "function") {
    web3d = GGBAppletUtils.makeModule("web3d", "FF0D077945B4F28C9687A57CE217EB73")
}
if (typeof window.webSimple !== "function") {
    webSimple = GGBAppletUtils.makeModule("webSimple", "68A083AB065814CF38FAFD55726F7611")
}
